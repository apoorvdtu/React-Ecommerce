...
export const EventIDActionsType = new Map([
  [PRODUCT_FORM_IDS.PRODUCT_NAME, ACTIONS.CHANGE_PRODUCT_NAME],
  [PRODUCT_FORM_IDS.PRODUCT_CATEGORY, ACTIONS.CHANGE_PRODUCT_CATEGORY],
  [PRODUCT_FORM_IDS.PRODUCT_ORIGINAL_PRICE, ACTIONS.CHANGE_PRODUCT_ORIGINAL_PRICE],
  [PRODUCT_FORM_IDS.PRODUCT_DISCOUNT_PRICE, ACTIONS.CHANGE_PRODUCT_DISCOUNT_PRICE],
  [PRODUCT_FORM_IDS.PRODUCT_STOCK_UNITS, ACTIONS.CHANGE_PRODUCT_STOCK_UNITS],
]);
